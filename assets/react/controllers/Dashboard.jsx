        ...
        <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
          <div>
            {/* <div className="-mx-6 px-6 py-4">
              <a href="#" title="home">
                <img
                  src="https://images.unsplash.com/photo-1511954766786-1f88f53fb528?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8YnVnfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                  className="w-32"
                  alt="tailus logo"
                  // width={32}
                  // height={32}
